...
@RestController
@RequestMapping("/api/v1/state_organization/")
public class StateOrganizationController {
    ...
    private final TypeOwnership typeOwnership=TypeOwnership.STATE_ORGANIZATION;

    public StateOrganizationController(CompanyService companyService, OrganizationService organizationService,
                                       TypeActivityService typeActivityService, LocalizationService localizationService,
                                       PersonService personService, FileService fileService, CocaiotMemberService cocaiotMemberService) {
    ...
    public ResponseEntity addCompany(@ModelAttribute Company company,
                                     @RequestParam(value = "organizationUuid", required = false)UUID organizationUuid,
        ...
        Map<String, Object>response=new LinkedHashMap<>();
        ResponseTransfer responseTransfer=organizationService.isOrganizationExistsByUuid(organizationUuid);
        ...
        responseTransfer=companyService.addCompany(company, organizationUuid, typeActivityUuids, typeOwnership,
                countryUuid, regionUuid, directorUuid, null, logoUuid, membershipApplicationUuid, extractFromUsreoUuid,
                charterOfTheEnterpriseUuid, certificateOfForeignEconomicRelationsUuid, certificateOfStateRegistrationUuid,
    ...
    public ResponseEntity editCompany(@ModelAttribute Company company,
        ...
        responseTransfer=companyService.editCompany(company, organizationUuid, typeActivityUuids, typeOwnership,
                countryUuid, regionUuid, directorUuid, null, logoUuid, membershipApplicationUuid, extractFromUsreoUuid,
                charterOfTheEnterpriseUuid, certificateOfForeignEconomicRelationsUuid, certificateOfStateRegistrationUuid,
                paymentOfTheEntranceMembershipFeeUuid);
        if(responseTransfer.isStatus()){
    ...
    public ResponseEntity getAmountCompanies(@RequestParam(value = "searchKey", required = false)String searchKey){
        ...
        Map<String, Object>response=new LinkedHashMap<>();
        final int amountEntrepreneurs=companyService.getAmountCompaniesBySearchKey(searchKey, typeOwnership);
