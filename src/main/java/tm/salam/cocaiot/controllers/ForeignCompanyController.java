...
@RestController
@RequestMapping("/api/v1/foreign-company/")
public class ForeignCompanyController {
    ...
    private final TypeOwnership typeOwnership=TypeOwnership.FOREIGN_COMPANY;

    public ForeignCompanyController(CompanyService companyService, TypeActivityService typeActivityService,
