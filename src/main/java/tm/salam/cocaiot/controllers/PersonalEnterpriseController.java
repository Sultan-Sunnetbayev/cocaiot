...
@RestController
@RequestMapping("/api/v1/personal-enterprise")
public class PersonalEnterpriseController {
    ...
    private final TypeOwnership typeOwnership=TypeOwnership.PERSONAL_ENTERPRISE;

    public PersonalEnterpriseController(CompanyService companyService, TypeActivityService typeActivityService,
    ...
    public ResponseEntity addCompany(@ModelAttribute Company company,
        ...
        responseTransfer=companyService.addCompany(company, null, typeActivityUuids, typeOwnership,
                countryUuid, regionUuid, directorUuid, founderUuids, logoUuid, membershipApplicationUuid, extractFromUsreoUuid,
                charterOfTheEnterpriseUuid, certificateOfForeignEconomicRelationsUuid, certificateOfStateRegistrationUuid,
